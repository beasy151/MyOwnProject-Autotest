...
public class LoginPage {
    ...
    /*Elements*/
    private By emailField = By.cssSelector("[name=\"email\"]"); /*Есть*/
    private By passField = By.cssSelector("[name=\"password\"]"); /*Есть*/
    private By rememberMeCheckBox = By.cssSelector("[name=\"remember_me\"]"); /*Есть*/
    private By loginButton = By.cssSelector("[name=\"login\"]"); /*Есть*/
